...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
    ...
    <div class="mb-6" wire:ignore>
        <form action="<?php echo e(route('admin.products.files', $product)); ?>" 
              method="POST"
              class="dropzone"
        ...
        <ul class="flex flex-wrap gap-3">
            ...
            <li class="relative" wire:key="image-<?php echo e($image->id); ?>">
                ...
                <img
                    ...
                    src="<?php echo e(Storage::url($image->url)); ?>"
                >
...
<?php endif; ?>
    ...
    <?php if($this->subcategory): ?>
        ...
        <?php if($this->subcategory->size): ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.size-product',
    ...
    $response = \Livewire\Livewire::mount('admin.size-product',
                ['product'=>$product]);
    $html = $response->html();
...
?>
        ...
        <?php elseif($this->subcategory->color): ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.color-product',
                ['product'=>$product])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.color-product',
                ['product'=>$product]);
    $html = $response->html();
