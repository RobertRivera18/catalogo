    ...
    <div class="bg-white rounded-2xl border-2 border-gray-200 p-6 mb-6 shadow-md hover:shadow-lg transition-shadow">
        ...
        <button
            ...
            <span class="relative z-10 flex items-center justify-center gap-3 text-base">
                <i class="fas fa-shopping-cart text-xl" 
                   :class="addingToCart ? 'animate-bounce' : ''"></i>
        ...
        <div 
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-green-700 mt-0.5"><?php echo e($qty); ?> <?php echo e($qty === 1 ? 'unidad agregada' : 'unidades agregadas'); ?> correctamente</p>
            </div>
        ...
        <div class="flex justify-center items-center gap-4 flex-wrap">
            <?php $__currentLoopData = range(1, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group bg-white p-4 rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-purple-300">
                    <img src="<?php echo e(asset('img/' . $i . '.svg')); ?>" 
                         alt="Método de pago <?php echo e($i); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\catalogo\catalogo\resources\views/livewire/add-cart-item.blade.php ENDPATH**/ ?>