...
} elseif ($_instance->childHasBeenRendered('l3546734690-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3546734690-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3546734690-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3546734690-0');
} else {
    $response = \Livewire\Livewire::mount('search');
    $html = $response->html();
    $_instance->logRenderedChild('l3546734690-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l3546734690-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3546734690-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3546734690-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3546734690-1');
} else {
    $response = \Livewire\Livewire::mount('dropdown-cart');
    $html = $response->html();
    $_instance->logRenderedChild('l3546734690-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('search')->html();
} elseif ($_instance->childHasBeenRendered('l3546734690-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3546734690-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3546734690-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3546734690-2');
} else {
    $response = \Livewire\Livewire::mount('search');
    $html = $response->html();
    $_instance->logRenderedChild('l3546734690-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l3546734690-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3546734690-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3546734690-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3546734690-3');
} else {
    $response = \Livewire\Livewire::mount('cart-mobil');
    $html = $response->html();
    $_instance->logRenderedChild('l3546734690-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\catalogo\catalogo\resources\views/livewire/navigation.blade.php ENDPATH**/ ?>