...
} elseif ($_instance->childHasBeenRendered('FS9M1d2')) {
    $componentId = $_instance->getRenderedChildComponentId('FS9M1d2');
    $componentTag = $_instance->getRenderedChildComponentTagName('FS9M1d2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FS9M1d2');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('FS9M1d2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
