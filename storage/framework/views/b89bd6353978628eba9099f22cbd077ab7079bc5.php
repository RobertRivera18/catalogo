...
} elseif ($_instance->childHasBeenRendered('3F5IQBJ')) {
    $componentId = $_instance->getRenderedChildComponentId('3F5IQBJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('3F5IQBJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3F5IQBJ');
} else {
    $response = \Livewire\Livewire::mount('navigation');
    $html = $response->html();
    $_instance->logRenderedChild('3F5IQBJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\catalogo\catalogo\resources\views/layouts/app.blade.php ENDPATH**/ ?>