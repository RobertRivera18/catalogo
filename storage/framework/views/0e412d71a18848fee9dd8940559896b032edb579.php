            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span
                        ...
                        ORDEN-<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?>
    ...
    <div class="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-8 md:p-12 mb-8">
        <div class="relative flex items-center justify-between">
            ...
            <div class="relative flex flex-col items-center flex-1">
                <div
                    class="relative z-10 flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full transition-all duration-500 <?php echo e($order->status >= 2 && $order->status != 5 ? 'bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg scale-110' : 'bg-gray-300'); ?>">
                ...
                <div class="absolute -bottom-10 md:-bottom-12 left-1/2 -translate-x-1/2 whitespace-nowrap">
                    <p
                        class="text-xs md:text-sm font-bold <?php echo e($order->status >= 2 && $order->status != 5 ? 'text-blue-600' : 'text-gray-500'); ?>">
                        Recibido
                    </p>
                    <?php if($order->status >= 2 && $order->status != 5): ?>
            ...
            <div
                class="flex-1 h-2 mx-2 rounded-full transition-all duration-500 <?php echo e($order->status >= 3 && $order->status != 5 ? 'bg-gradient-to-r from-blue-500 to-blue-600' : 'bg-gray-300'); ?>">
            </div>

            
            <div class="relative flex flex-col items-center flex-1">
                <div
                    class="relative z-10 flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full transition-all duration-500 <?php echo e($order->status >= 3 && $order->status != 5 ? 'bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg scale-110' : 'bg-gray-300'); ?>">
                    <i
                        class="fas fa-shipping-fast text-white text-xl md:text-2xl <?php echo e($order->status == 3 && $order->status != 5 ? 'animate-pulse' : ''); ?>"></i>
                </div>
                <div class="absolute -bottom-10 md:-bottom-12 left-1/2 -translate-x-1/2 whitespace-nowrap">
                    <p
                        class="text-xs md:text-sm font-bold <?php echo e($order->status >= 3 && $order->status != 5 ? 'text-blue-600' : 'text-gray-500'); ?>">
                        Enviado
                    </p>
            ...
            <div
                class="flex-1 h-2 mx-2 rounded-full transition-all duration-500 <?php echo e($order->status >= 4 && $order->status != 5 ? 'bg-gradient-to-r from-blue-500 to-green-500' : 'bg-gray-300'); ?>">
            </div>

            
            <div class="relative flex flex-col items-center flex-1">
                <div
                    class="relative z-10 flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full transition-all duration-500 <?php echo e($order->status >= 4 && $order->status != 5 ? 'bg-gradient-to-br from-green-500 to-green-600 shadow-lg scale-110' : 'bg-gray-300'); ?>">
                    <i class="fas fa-gift text-white text-xl md:text-2xl"></i>
                </div>
                <div class="absolute -bottom-10 md:-bottom-12 left-1/2 -translate-x-1/2 whitespace-nowrap">
                    <p
                        class="text-xs md:text-sm font-bold <?php echo e($order->status >= 4 && $order->status != 5 ? 'text-green-600' : 'text-gray-500'); ?>">
                        Entregado
                    </p>
        ...
        <div class="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-6">
                <div
                    ...
                    <i
                        class="fas <?php echo e($order->envio_type == 1 ? 'fa-store' : 'fa-shipping-fast'); ?> text-white text-xl"></i>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-5 border-2 border-green-200">
                    ...
                    <div class="bg-white rounded-lg p-4 border border-green-200 space-y-2">
                        <p class="text-sm">
                            ...
                            <span class="font-semibold text-gray-900"><?php echo e($order->address); ?></span>
                        </p>
                        <p class="text-sm text-gray-600 pl-6">
                            <?php echo e($order->department->name); ?> - <?php echo e($order->city->name); ?> - <?php echo e($order->district->name); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-lg p-4 border border-purple-200">
                        <p class="text-xs text-gray-500 mb-1 uppercase tracking-wide font-semibold">Teléfono de
                            contacto</p>
                        <a href="tel:<?php echo e($order->phone); ?>"
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="py-4 px-2">
                                <div class="flex items-center gap-4">
                                    ...
                                    <article class="flex-1">
                                        <h3 class="font-bold text-gray-900 mb-1"><?php echo e($item->name); ?></h3>
                            ...
                            <td class="text-center py-4 px-2">
                                <span class="font-bold text-gray-900">$<?php echo e(number_format($item->price, 2)); ?></span>
                            </td>
                            <td class="text-center py-4 px-2">
                                <span
                            ...
                            <td class="text-right py-4 px-2">
                                <span
                                    class="font-black text-gray-900 text-lg">$<?php echo e(number_format($item->price * $item->qty, 2)); ?></span>
                            </td>
                        </tr>
                    ...
                    <tr class="border-t-2 border-gray-300">
                        ...
                        <td class="text-right py-6 px-2">
                            <span class="text-3xl font-black text-green-600">
                                $<?php echo e(number_format(collect($items)->sum(fn($item) => $item->price * $item->qty), 2)); ?>
...
<?php /**PATH C:\xampp\htdocs\catalogo\resources\views/livewire/status-order.blade.php ENDPATH**/ ?>