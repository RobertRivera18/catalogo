        ...
        <div class="bg-white rounded-lg shadow-lg">
            <div class="px-4 py-3 space-y-1">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('products.show', $product)); ?>" class="flex items-center gap-3">
                        ...
                        <div class="w-16 h-12 bg-gray-100 rounded flex items-center justify-center overflow-hidden">
                            <img class="max-w-full max-h-full object-contain"
                                src="<?php echo e(Storage::url($product->images->first()->url ?? 'img/default.jpg')); ?>"
                        ...
                        <div class="text-gray-700 flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500">
                                Categoría: <?php echo e($product->subcategory->category->name ?? 'Sin categoría'); ?>
...
<?php /**PATH C:\xampp\htdocs\catalogo\resources\views/livewire/search.blade.php ENDPATH**/ ?>