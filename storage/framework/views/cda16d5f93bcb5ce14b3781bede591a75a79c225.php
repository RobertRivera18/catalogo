<div x-data>
    ...
    <div>
        ...
        <button 
        type="button"
        wire:click="$set('size_id', <?php echo e($size->id); ?>)"
        class="px-4 py-2 rounded-md shadow-sm border 
               transition-colors duration-200 ease-in-out
               focus:outline-none focus:ring-2 focus:ring-indigo-500
               <?php echo e($size_id === $size->id ? 'bg-indigo-500 text-white border-indigo-500' : 'bg-gray-100 text-gray-700 border-gray-300 hover:bg-gray-200'); ?>">
...
<div class="mt-2">
    ...
    <ul class="flex flex-wrap items-center">
        <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="mr-4 mb-4">
                <div 
                    wire:click="$set('color_id', <?php echo e($color->id); ?>)"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['disabled' => true,'xBind:disabled' => '$wire.qty <= 1','wire:loading.attr' => 'disabled','wire:target' => 'decrement','wire:click' => 'decrement']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['xBind:disabled' => '$wire.qty >= $wire.quantity','wire:loading.attr' => 'disabled','wire:target' => 'increment','wire:click' => 'increment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
</div><?php /**PATH C:\xampp\htdocs\catalogo\resources\views/livewire/add-cart-item-size.blade.php ENDPATH**/ ?>