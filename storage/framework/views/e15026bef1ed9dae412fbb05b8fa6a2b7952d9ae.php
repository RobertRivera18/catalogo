...
} elseif ($_instance->childHasBeenRendered('4CxgKpn')) {
    $componentId = $_instance->getRenderedChildComponentId('4CxgKpn');
    $componentTag = $_instance->getRenderedChildComponentTagName('4CxgKpn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4CxgKpn');
} else {
    $response = \Livewire\Livewire::mount('navigation');
    $html = $response->html();
    $_instance->logRenderedChild('4CxgKpn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tienda1\resources\views/layouts/app.blade.php ENDPATH**/ ?>