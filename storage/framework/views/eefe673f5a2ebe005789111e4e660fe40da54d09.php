...
} elseif ($_instance->childHasBeenRendered('xfbzjBI')) {
    $componentId = $_instance->getRenderedChildComponentId('xfbzjBI');
    $componentTag = $_instance->getRenderedChildComponentTagName('xfbzjBI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xfbzjBI');
} else {
    $response = \Livewire\Livewire::mount('add-cart-item', ['product' => $product]);
    $html = $response->html();
    $_instance->logRenderedChild('xfbzjBI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
