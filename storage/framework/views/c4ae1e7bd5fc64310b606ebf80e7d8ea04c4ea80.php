        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
                    ...
                    <?php echo e($view === 'grid' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100'); ?>">
                    ...
                    <?php echo e($view === 'list' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100'); ?>">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" wire:click="$set('category', '<?php echo e($category->slug); ?>')"
                                    class="w-full text-left px-4 py-3 rounded-xl transition-all duration-200 <?php echo e($category->slug === $categorySelected ? 'bg-gray-500 text-white shadow-md' : 'bg-gray-50 text-gray-700 hover:bg-orange-50 hover:text-gray-600'); ?>">
        ...
        <div class="overflow-x-auto pb-2 -mx-4 px-4">
            <div class="flex gap-2 min-w-max">
                <button wire:click="$set('category', '')"
                    class="px-4 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap <?php echo e(!$categorySelected ? 'bg-gray-500 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-orange-300'); ?>">
                    Todos
                </button>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button wire:click="$set('category', '<?php echo e($category->slug); ?>')"
                        class="px-4 py-2 rounded-full text-sm font-medium transition-all whitespace-nowrap <?php echo e($category->slug === $categorySelected ? 'bg-gray-500 text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:border-gray-300'); ?>">
...
<?php /**PATH C:\xampp\htdocs\catalogo\resources\views/livewire/products-home.blade.php ENDPATH**/ ?>