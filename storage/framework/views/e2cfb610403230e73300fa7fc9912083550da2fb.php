...
<?php foreach($attributes->onlyProps(['size'=>35,'color'=>'gray']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="<?php echo e($size); ?>" height="<?php echo e($size); ?>" viewBox="0,0,256,256"
    style="fill:#000000;">
    <g fill="<?php echo e($col); ?>" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter"
...
</svg><?php /**PATH C:\xampp\htdocs\catalogo\catalogo\resources\views/components/search.blade.php ENDPATH**/ ?>