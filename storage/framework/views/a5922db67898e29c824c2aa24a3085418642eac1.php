...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$emit(\'deleteProduct\')']); ?>Eliminar <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <section class="bg-white shadow-xl rounded-lg p-6 mb-4">
            ...
            <ul class="flex flex-wrap">
                ...
                <li class="relative" wire:key="image-<?php echo e($image->id); ?>">
                    <img class="w-32 h-20 rounded-sm object-cover" src="<?php echo e(Storage::url($image->url)); ?>" alt="">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['class' => 'absolute right-2 top-2','wire:click' => 'deleteImage('.e($image->id).')','wire:loading.attr' => 'disabled','wire.target' => 'deleteImage('.e($image->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('danger-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'absolute right-2 top-2','wire:click' => 'deleteImage('.e($image->id).')','wire:loading.attr' => 'disabled','wire.target' => 'deleteImage('.e($image->id).')']); ?>
                        x
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','disabled' => true,'wire:model' => 'slug','class' => 'w-full bg-gray-200','placeholder' => 'Ingrese del Slug del Producto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','disabled' => true,'wire:model' => 'slug','class' => 'w-full bg-gray-200','placeholder' => 'Ingrese del Slug del Producto']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
</div><?php /**PATH C:\xampp\htdocs\catalogo\catalogo\resources\views/livewire/admin/edit-product.blade.php ENDPATH**/ ?>