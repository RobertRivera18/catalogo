                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <x-input
                            class="w-full h-10 rounded-xl border-gray-200 text-sm
                                focus:ring-2 focus:ring-black/10 focus:border-gray-400 transition"
                            wire:model="address" type="text" placeholder="Av. Principal 456, Dpto 3B" />
                    ...
                    <div class="flex flex-col gap-1.5 md:col-span-2">
                        ...
                        <x-input
                            class="w-full h-10 rounded-xl border-gray-200 text-sm
                                focus:ring-2 focus:ring-black/10 focus:border-gray-400 transition"
                            wire:model="references" type="text" placeholder="Ej: Frente al parque, edificio azul" />
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-4">
        ...
        <div class="bg-gray-50 border-t border-gray-100 px-5 py-4 space-y-2.5">
            <div class="flex justify-between items-center text-sm">
                ...
                <span class="font-medium text-gray-800">${{ Cart::subTotal() }}</span>
            </div>

            <div class="flex justify-between items-center text-sm">
                <span class="text-gray-500">Envío</span>
                <span class="font-medium {{ ($envio_type == 1 || $shipping_cost == 0) ? 'text-green-700' : 'text-gray-800' }}">
            ...
            <div class="flex justify-between items-baseline pt-0.5">
                ...
                <span class="text-xl font-medium text-gray-900">
                    ${{ $envio_type == 1 ? Cart::subTotal() : Cart::subTotal() + $shipping_cost }}
                </span>
            </div>
        </div>
    </div>
